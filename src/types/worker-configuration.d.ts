/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/types/worker-configuration.d.ts --env-interface CloudflareBindings` (hash: a85034c755a7c3d716b5eaa7561eb258)
// Runtime types generated with workerd@1.20250525.0 2025-06-04 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		DATABASE_URL: string;
		DEX_SSCR_BUCKET: R2Bucket;
	}
}
